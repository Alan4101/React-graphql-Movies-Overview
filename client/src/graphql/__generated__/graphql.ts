...
export type LoginUserMutation = { __typename?: 'Mutation', loginUser: { __typename?: 'TokenResponse', status: string, user: { __typename?: 'User', authToken: string, lastName: string, _id: string, firstName: string, picture: string, role: string, recomendedList: Array<{ __typename?: 'RecomendedMovies', _id: string, createdData: string, description: string, title: string, movies: Array<{ __typename?: 'MovieSelected', _id: string, adult?: boolean | null, backdropPath?: string | null, genres: Array<string>, overview?: string | null, poster: string, releaseDate: string, title: string, sequenceNumber?: number | null, userDescription?: string | null, voteAverage?: number | null, voteCount?: number | null, movieId: string }> }> } } };
...
export type SignUpUserMutation = { __typename?: 'Mutation', signUpUser: { __typename?: 'UserResponse', status: string, user: { __typename?: 'User', createdAt?: any | null, firstName: string, email: string, age: number, _id: string, lastName: string, password: string, picture: string, role: string, updatedAt?: any | null, verified: boolean } } };
